...
var Recipes = map[string]BenchmarkRecipe{
	"CASH": {
		...
		Components:  []AssetAllocation{{Symbol: "SGOV", Weight: money.MustWeight("1")}},
	},
	"SPY": {
		ID: "SPY", Name: "S&P 500",
		Description: "Broad US equity benchmark.",
		Components:  []AssetAllocation{{Symbol: "SPY", Weight: money.MustWeight("1")}},
	},
	"VOO": {
		ID: "VOO", Name: "Bogle Broad Index",
		Description: "Broad US passive index benchmark.",
		Components:  []AssetAllocation{{Symbol: "VOO", Weight: money.MustWeight("1")}},
	},
	"GOLD": {
		ID: "GOLD", Name: "Gold",
		Description: "Gold benchmark.",
		Components:  []AssetAllocation{{Symbol: "GLD", Weight: money.MustWeight("1")}},
	},
	"BALANCED_60_40": {
		ID: "BALANCED_60_40", Name: "60/40 Portfolio",
		Description: "60% equities, 40% bonds.",
		Components: []AssetAllocation{
			{Symbol: "SPY", Weight: money.MustWeight("0.6")},
			{Symbol: "BND", Weight: money.MustWeight("0.4")},
		},
	},
	"GLOBAL_EQUITY": {
		ID: "GLOBAL_EQUITY", Name: "Global Equity",
		Description: "Global stock market benchmark.",
		Components:  []AssetAllocation{{Symbol: "VT", Weight: money.MustWeight("1")}},
	},
	"DIVIDEND": {
		ID: "DIVIDEND", Name: "Dividend Strategy",
		Description: "Dividend equity benchmark.",
		Components:  []AssetAllocation{{Symbol: "SCHD", Weight: money.MustWeight("1")}},
	},
	"INFLATION_DEFENSE": {
		ID: "INFLATION_DEFENSE", Name: "Inflation Defense",
		Description: "Gold plus cash defensive basket.",
		Components: []AssetAllocation{
			{Symbol: "GLD", Weight: money.MustWeight("0.5")},
			{Symbol: "SGOV", Weight: money.MustWeight("0.5")},
		},
	},
	"CMDTY": {
		...
		Components: []AssetAllocation{
			{Symbol: "GLD", Weight: money.MustWeight("0.25")},
			{Symbol: "SIVR", Weight: money.MustWeight("0.25")},
			{Symbol: "XLE", Weight: money.MustWeight("0.25")},
			{Symbol: "URA", Weight: money.MustWeight("0.25")},
		},
	},
	"ORACLE_BERKSHIRE": {
		ID: "ORACLE_BERKSHIRE", Name: "Berkshire Hathaway",
		Description: "Berkshire Hathaway shareholder return benchmark.",
		Components:  []AssetAllocation{{Symbol: "BRK.B", Weight: money.MustWeight("1")}},
	},
	"BUFFETT_13F": {
	...
	"ALL_WEATHER": {
		...
		Components: []AssetAllocation{
			{Symbol: "SPY", Weight: money.MustWeight("0.3")},
			{Symbol: "TLT", Weight: money.MustWeight("0.4")},
			{Symbol: "GLD", Weight: money.MustWeight("0.15")},
			{RecipeRef: "CMDTY", Weight: money.MustWeight("0.075")},
			{Symbol: "SGOV", Weight: money.MustWeight("0.075")},
		},
	},
	"MUNGER_QUALITY": {
		...
		Components: []AssetAllocation{
			{Symbol: "QUAL", Weight: money.MustWeight("0.4")},
			{Symbol: "BRK.B", Weight: money.MustWeight("0.3")},
			{Symbol: "VOO", Weight: money.MustWeight("0.2")},
			{Symbol: "SGOV", Weight: money.MustWeight("0.1")},
		},
	},
	"GRAHAM_DEFENSIVE_VALUE": {
		...
		Components: []AssetAllocation{
			{Symbol: "VTV", Weight: money.MustWeight("0.4")},
			{Symbol: "SCHD", Weight: money.MustWeight("0.3")},
			{Symbol: "SGOV", Weight: money.MustWeight("0.2")},
			{Symbol: "GLD", Weight: money.MustWeight("0.1")},
		},
	},
	"LYNCH_GROWTH": {
		...
		Components: []AssetAllocation{
			{Symbol: "VOO", Weight: money.MustWeight("0.4")},
			{Symbol: "IJR", Weight: money.MustWeight("0.3")},
			{Symbol: "QQQ", Weight: money.MustWeight("0.2")},
			{Symbol: "SGOV", Weight: money.MustWeight("0.1")},
		},
	},
	"SWENSEN_ENDOWMENT": {
		...
		Components: []AssetAllocation{
			{Symbol: "VOO", Weight: money.MustWeight("0.3")},
			{Symbol: "VXUS", Weight: money.MustWeight("0.2")},
			{Symbol: "BND", Weight: money.MustWeight("0.2")},
			{Symbol: "VNQ", Weight: money.MustWeight("0.15")},
			{Symbol: "GLD", Weight: money.MustWeight("0.1")},
			{Symbol: "SGOV", Weight: money.MustWeight("0.05")},
		},
	},
	"SOROS_MACRO": {
		...
		Components: []AssetAllocation{
			{Symbol: "SPY", Weight: money.MustWeight("0.3")},
			{Symbol: "TLT", Weight: money.MustWeight("0.2")},
			{Symbol: "GLD", Weight: money.MustWeight("0.2")},
			{Symbol: "UUP", Weight: money.MustWeight("0.15")},
			{RecipeRef: "CMDTY", Weight: money.MustWeight("0.15")},
		},
	},
	"QUANT_STYLE": {
		...
		Components: []AssetAllocation{
			{Symbol: "SPY", Weight: money.MustWeight("0.35")},
			{Symbol: "QQQ", Weight: money.MustWeight("0.25")},
			{Symbol: "SGOV", Weight: money.MustWeight("0.2")},
			{Symbol: "GLD", Weight: money.MustWeight("0.1")},
			{Symbol: "USMV", Weight: money.MustWeight("0.1")},
		},
	},
	"DRUCKENMILLER_MACRO_GROWTH": {
		...
		Components: []AssetAllocation{
			{Symbol: "QQQ", Weight: money.MustWeight("0.35")},
			{Symbol: "SPY", Weight: money.MustWeight("0.25")},
			{Symbol: "GLD", Weight: money.MustWeight("0.15")},
			{Symbol: "TLT", Weight: money.MustWeight("0.1")},
			{Symbol: "XLE", Weight: money.MustWeight("0.1")},
			{Symbol: "SGOV", Weight: money.MustWeight("0.05")},
		},
	},
}
