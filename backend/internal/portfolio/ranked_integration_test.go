...
func rankedIndex(t *testing.T, perf *performance.Service, userID string) money.IndexValue {
	t.Helper()
...
func TestRanked_FirstPositionStartsAt100(t *testing.T) {
	...
	require.NoError(t, err)
	assertIndexEqual(t, "100.0", rankedIndex(t, perf, "u1"))
}
...
func TestRanked_MarketMovePropagates(t *testing.T) {
	...
	assertIndexEqual(t, "80.0", rankedIndex(t, perf, "u1"))
}
...
func TestRanked_CapitalInjectionCannotDilute(t *testing.T) {
	...
	assertIndexEqual(t, "50.0", rankedIndex(t, perf, "u1"))
...
func TestRanked_DeleteAndReAddDoesNotReset(t *testing.T) {
	...
	assertIndexEqual(t, "80.0", rp.RankedIndex)
...
func TestRanked_StrategyReplaceDoesNotReset(t *testing.T) {
	...
	assertIndexEqual(t, "90.0", rankedIndex(t, perf, "u1"))
